...
[![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/Sebastian-Schuchmann/ChurrorsNachosClassifier/blob/main/Train_a_Food_Model.ipynb)
...
```bash
docker build -t churros_nachos_classifier . && docker run --rm -it -p 5000:5000 churros_nachos_classifier
```
